...
class MaquinaAguaTest {
  ...
  @Test
  @DisplayName("Servir 66 copos de 300ml e servir um de 200ml, deve zerar a quantidade de agua")
  void testeServir66Copos300mlEum200mlDeveZerarQuantidadeAgua() {
    MaquinaAgua maquina = new MaquinaAgua();
    ...
    Assertions.assertEquals(99, maquina.copos200(), "quantidade de copos de 200 é 1");
    Assertions.assertEquals(34, maquina.copos300(), "quantidade de copos de 300 é 100");
